...
{
    internal class EntryVoteRepository : GenericRepository<EntryVote>, IEntryVoteRepository
    {
        public EntryVoteRepository(DictionaryDbContext context) : base(context)
        {
        }
    }
}
